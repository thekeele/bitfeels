...
require.register("js/timefeels.js", function(exports, require, module) {
"use strict";
...
function makeChart(data) {
  ...
  var svg = d3.select('#timefeels').append('svg').attr('width', svgWidth).attr('height', svgHeight).append('g').attr('transform', 'translate(' + margin.left + ',' + margin.top + ')');
...
var data = rawDataJSON.map(function (d) {
  return {
